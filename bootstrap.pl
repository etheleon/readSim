...
#system  "$baseDIR/readSim.0101.contigsXscaffolds.pl out/readSim.0100.woCompleteGenomes_taxidList $config->{cypherurl} $config->{refseq}, $config->{ncbiTaxonomy}";
